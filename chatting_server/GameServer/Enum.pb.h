...
constexpr UserType UserType_MIN = USER_TYPE_NONE;
constexpr UserType UserType_MAX = USER_TYPE_ADMIN;
...
template <> struct is_proto_enum< ::Protocol::UserType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Protocol::UserType>() {
  return ::Protocol::UserType_descriptor();
}
